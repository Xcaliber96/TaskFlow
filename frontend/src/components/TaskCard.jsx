...
function TaskCard({ id, title, priority, deleteTask, dueDate, editTask, updatePriority, selectedTaskId, setSelectedTaskId }) {
  ...
  const priorityStyle = priorityConfig[safePriority] || priorityConfig["Low"];
      ...
      {isEditing ? (
        ...
        <>
          ...
          <div className="flex items-center gap-2 mt-auto">
            <span className={`flex items-center gap-1 px-1.5 py-0.5 rounded text-[10px] font-medium border ${priorityStyle.class}`}>
              <span className="opacity-70">{priorityStyle.icon}</span>
              {safePriority}
            </span>
